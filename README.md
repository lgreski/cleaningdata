...
* Submit a link to a GitHub repository with the code for performing your analysis. The code shoul dhave a file *run_analysis.R* in the main directory that can be run as long as the Samsung data is in the working directory
...
* Include a README.md file in the repository describing hothe script works
